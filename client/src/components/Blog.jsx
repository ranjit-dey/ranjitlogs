    ...
    return data ? (
        <div className="relative">
            ...
            <div className="text-center mt-20 text-gray-600">
                <p className="text-primary py-4 font-medium">{`Published on ${moment(
                    data.createdAt,
            ...
            <div className="mx-5 max-w-5xl md:mx-auto my-10 mt-6">
                <img src={data.image} alt="blog-banner" className="rounded-3xl mb-5" />
                <div
                ...
                <div className="mt-14 mb-10 max-w-3xl mx-auto">
                    ...
                    <div className="flex flex-col gap-4">
                        {comments.map((item, index) => (
                            <div
                                key={index}
                                className="relative bg-primary/10 border border-primary/20 max-w-xl p-4 rounded text-gray-600"
                            >
